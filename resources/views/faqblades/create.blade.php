...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <form action="" method="post" name="createFaqFrom" id="createFaqFrom">
                    <div class="card">
                        <div class="card-header">{{ __('Faq Create') }}</div>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-4">
                                    <br>
...
@section('extraJs')
    <script type="text/javascript">
        $("#createFaqFrom").submit(function(event) {
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'json',
                data: $("#createFaqFrom").serializeArray(),
