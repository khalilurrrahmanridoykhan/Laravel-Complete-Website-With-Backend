            ...
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active"
                        style="background-image: url('{{ asset('fontend/assets/images/banner.jpg') }}') ;">
                            ...
                            <div class="row align-items-center d-flex h-100">
                                <div class="col-md-7">
                                    <div class="block">
                                        ...
                                        <h1 class="mb-3 mt-3">If you love life, don’t waste time, for time is what life is
                                            made up of</h1>
                    ...
                    <div class="carousel-item"
                        style="background-image: url({{ asset('fontend/assets/images/banner24.jpg') }}) ;">
                        <div class="hero-background-overlay"></div>
                ...
                <div class="row">
                    <div class="col-md-6 align-items-center d-flex">
                        <div class="about-block">
                            ...
                            <p>This is a great space to write long text about your company and your services. You can use
                            ...
                            @foreach ($service as $services)
                                <div class="card border-0 ">
                                    ...
                                    <div class="card-body p-3">
                                        <h1 class="card-title mt-2"><a href="#">{{ $services->name }}</a></h1>
