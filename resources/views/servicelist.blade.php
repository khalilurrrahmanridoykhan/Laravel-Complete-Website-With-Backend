                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <a name="" id="" class="btn btn-success"
                                        href="{{ route('admin.service.create') }}" role="button">Create</a>
                                </div>
                                <div class="col-md-8">
                                            ...
                                            @if (!empty($service))
                                                @foreach ($service as $services)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span>
                                                                <a href="{{ route('admin.service.edit',$services->services_id ) }}"><img
                                                                        src="{{ asset('admin/assets/myImages/edit-property-24.png') }}"
                                                                        alt=""></a>
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a href="{{ route('admin.service.delete', $services->services_id) }}"><img
